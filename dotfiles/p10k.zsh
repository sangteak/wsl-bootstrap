# Generated by Powerlevel10k configuration wizard on 2025-11-26 at 10:29 KST.
...
() {
  ...
  # 항상 표시하도록 비활성화함 (AWS/minikube 혼동 방지). 다시 명령 입력 시에만 보이게 하려면 아래 주석 해제.
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_CLASSES=(
      '*arn:aws*|*eks*'  AWS      # AWS EKS 클러스터 (운영/원격) -> 위험색
      'minikube*'        LOCAL    # 로컬 minikube -> 안전색
      '*'                DEFAULT)
  # AWS: 흰 글씨 + 빨강 배경 (위험 — 잘못 실행하면 안 되는 환경)
  typeset -g POWERLEVEL9K_KUBECONTEXT_AWS_FOREGROUND=7
  typeset -g POWERLEVEL9K_KUBECONTEXT_AWS_BACKGROUND=1
  typeset -g POWERLEVEL9K_KUBECONTEXT_AWS_VISUAL_IDENTIFIER_EXPANSION='☁️'  # AWS = 구름 이모지 (눈에 잘 띄게)
  # LOCAL(minikube): 검은 글씨 + 초록 배경 (안전 — 마음껏 테스트 가능)
  ...
  # 오른쪽 프롬프트에서도 아이콘(☁️/🐳)을 텍스트 앞쪽에 표시.
  ...
  # AWS 클래스: 긴 ARN 대신 "AWS:<클러스터명>" 으로 짧게 표시 + 네임스페이스.
  typeset -g POWERLEVEL9K_KUBECONTEXT_AWS_CONTENT_EXPANSION=
  POWERLEVEL9K_KUBECONTEXT_AWS_CONTENT_EXPANSION+='AWS:${P9K_KUBECONTEXT_CLOUD_CLUSTER:-${P9K_KUBECONTEXT_NAME}}'
  POWERLEVEL9K_KUBECONTEXT_AWS_CONTENT_EXPANSION+='${${:-/$P9K_KUBECONTEXT_NAMESPACE}:#/default}'
  # LOCAL 클래스: "minikube" + 네임스페이스.
  typeset -g POWERLEVEL9K_KUBECONTEXT_LOCAL_CONTENT_EXPANSION=
  POWERLEVEL9K_KUBECONTEXT_LOCAL_CONTENT_EXPANSION+='${P9K_KUBECONTEXT_NAME}'
  POWERLEVEL9K_KUBECONTEXT_LOCAL_CONTENT_EXPANSION+='${${:-/$P9K_KUBECONTEXT_NAMESPACE}:#/default}'
